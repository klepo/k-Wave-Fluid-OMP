...
void Hdf5FileHeader::readHeaderFromCheckpointFile(Hdf5File& checkpointFile) {
  ...
  if (getFileType() == FileType::kCheckpoint) {
    mHeaderValues[FHI::kCreatedBy]       = checkpointFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kCreatedBy]);
    mHeaderValues[FHI::kCreationDate]    = checkpointFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kCreationDate]);
    mHeaderValues[FHI::kFileDescription] = checkpointFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kFileDescription]);
    mHeaderValues[FHI::kMajorVersion]    = checkpointFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kMajorVersion]);
    mHeaderValues[FHI::kMinorVersion]    = checkpointFile.readStringAttribute(rootGroup, "/", sHeaderNames[FHI::kMinorVersion]);
  } else {
