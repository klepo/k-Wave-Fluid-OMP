...
# CC Compiler Flags
CCFLAGS=-m64 -std=c++11 -O3 -Wall -fopenmp -mavx -mtune=native -march=native -ffast-math -fassociative-math
CXXFLAGS=-m64 -std=c++11 -O3 -Wall -fopenmp -mavx -mtune=native -march=native -ffast-math -fassociative-math
...
LDLIBSOPTIONS=-L./ -L${EBROOTHDF5}/lib -L${EBROOTFFTW}/lib -Wl,-rpath,'./' -Wl,-rpath,'${EBROOTHDF5}/lib' -Wl,-rpath,'${EBROOTFFTW}/lib' -lz -lfftw3f -lfftw3f_omp -lhdf5 -lhdf5_hl
...
${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-omp: ${OBJECTFILES}
	...
	g++ -o ${CND_DISTDIR}/${CND_CONF}/k-wave-fluid-omp ${OBJECTFILES} ${LDLIBSOPTIONS} -O3 -Wall -fopenmp -mavx -mtune=native -march=native
...
${OBJECTDIR}/Hdf5/Hdf5FileHeader.o: Hdf5/Hdf5FileHeader.cpp
	${MKDIR} -p ${OBJECTDIR}/Hdf5
	${RM} "$@.d"
	$(COMPILE.cc) -w -I./ -I${EBROOTHDF5}/include -I${EBROOTFFTW}/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hdf5/Hdf5FileHeader.o Hdf5/Hdf5FileHeader.cpp
