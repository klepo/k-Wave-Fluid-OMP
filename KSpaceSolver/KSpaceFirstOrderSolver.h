...
class KSpaceFirstOrderSolver
{
  ...
  protected:
     ...
     */
    void computeVelocitySourceTerm(
     ...
     * \endcode
     */
    template<Parameters::SimulationDimension simulationDimension> void computeInitialVelocityHeterogeneous();
    /**
     ...
     *
     */
    template<Parameters::SimulationDimension simulationDimension> void computeInitialVelocityHomogeneousUniform();
    /**
     ...
     * \endcode
     */
    template<Parameters::SimulationDimension simulationDimension> void computeInitialVelocityHomogeneousNonuniform();
     ...
     * \endcode
     */
    template<Parameters::SimulationDimension simulationDimension> void computeVelocityHeterogeneous();
     ...
     * \endcode
     */
    template<Parameters::SimulationDimension simulationDimension> void computeVelocityHomogeneousUniform();
    /**
     ...
     * \endcode
     */
    template<Parameters::SimulationDimension simulationDimension> void computeVelocityHomogeneousNonuniform();
     ...
     * \endcode
     */
    template<Parameters::SimulationDimension simulationDimension> void computePressureGradient();
    /**
    ...
    void computePressureTermsNonlinear(
    ...
    void sumPressureTermsNonlinear(
     ...
     * @tparam simulationDimension - Dimensionality of the simulation.
     */
    template<Parameters::SimulationDimension simulationDimension> void sumPressureTermsLinearLossless();
