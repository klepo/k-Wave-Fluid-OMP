...
%                     vectors), [Nx, Ny] in 2D and [Nx, Ny, Nz] in 3D. Here
%                     Nx is the number of elements in the row direction, Ny
%                     is the number of elements in the column direction,
%                     and Nz is the number of elements in the depth
%                     direction. 
%
% OPTIONAL INPUTS:
